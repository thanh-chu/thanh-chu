...
<section id="contact" class="section section--border-bottom rad-animation-group">
  <div class="container">
    <div class="row rad-fade-down">
      <div class="col-12 text-center">
        <h2>Cùng nhau xây dựng điều gì đó</h2>
        <p class="lead mb-4">Sẵn sàng cho các vị trí thực tập phát triển phần mềm và cơ hội mới — tôi phản hồi nhanh và dễ dàng trao đổi.</p>
        <div class="d-flex flex-wrap justify-content-center gap-3">
          <a href="mailto:thanhhachu87@gmail.com" class="btn btn-primary">
            <i class="icon-email"></i>&nbsp; Gửi email
          </a>
